...
public class DragCamera2DInspector : Editor {
    ...
    public override void OnInspectorGUI() {
        ...
        if (doubleClickEnabled) {
            ...
            dc2d.DCZoomTargetIn = EditorGUILayout.Slider(new GUIContent("DC Zoom Target In", "Target Zoom Level for DC"), dc2d.DCZoomTargetIn, 0.1f, 1000f);
            dc2d.DCZoomTranslateSpeed = EditorGUILayout.Slider(new GUIContent("DC Zoom Translate Speed", "DC Translation Speed"), dc2d.DCZoomTranslateSpeed, 0.01f, 100f);
            dc2d.DCZoomTargetOut = EditorGUILayout.Slider(new GUIContent("DC Zoom Target Out", "DCZoomSpeed"), dc2d.DCZoomTargetOut, 0.1f, 1000f);
            dc2d.DCZoomSpeed = EditorGUILayout.Slider(new GUIContent("DC Zoom Speed", "DC Zoom Speed"), dc2d.DCZoomSpeed, 0.01f, 100f);
            EditorGUI.indentLevel--;
        }
        GUILayout.Space(20f);
        ...
        if (zoomGUIEnabled) {
            ...
            dc2d.minZoom = EditorGUILayout.Slider(new GUIContent("Min Zoom", "Minimum Zoom Level"), dc2d.minZoom, 0, 1000);
            dc2d.zoomStepSize = EditorGUILayout.Slider(new GUIContent("Zoom Step Size", "The Speed the zoom changes"), dc2d.zoomStepSize, 0, 100);
